defmodule OneTouchLoginTest do
  ...
  test "One Touch Login by Email" do
    ...
    test_otlbe_response = "testaccountauto@mailinator.com"
      |> LoginRadius.OneTouchLogin.login_by_email(testcguid, "testaccountauto", "www.test.com", "onetouchlogin-default", "welcome-default")

    assert elem(test_otlbe_response, 0) == :ok
  end

  test "One Touch Login by Phone" do
    test_otlbp_response = "17787694512"
