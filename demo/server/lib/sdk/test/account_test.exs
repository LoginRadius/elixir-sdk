defmodule AccountTest do
  ...
  test "Account Email Verification Token" do
    test_data_evt_response = Map.put(%{}, "email", "testaccountauto@mailinator.com")
  ...
  test "Account Forgot Password Token" do
    test_data_fpt_response = Map.put(%{}, "email", "testaccountauto@mailinator.com")
  ...
  test "Account Identities by Email" do
    test_data_ibe_response = "testaccountauto@mailinator.com"
  ...
  test "Account Impersonation Access Token", %{"test_data" => test_data} do
    test_data_iat_response = get_uid(test_data)
  ...
  test "Account Retrieve Hashed Password", %{"test_data" => test_data} do
    test_data_rhp_response = get_uid(test_data)
  ...
  test "Account Retrieve Profile by Email" do
    test_data_rpbe_response = "testaccountauto@mailinator.com"
  ...
  test "Account Retrieve Profile by Username" do
    test_data_rpbusername_response = "taa"
  ...
  test "Account Retrieve Profile by PhoneID" do
    test_data_rpbp_response = "17787694512"
  ...
  test "Account Retrieve Profile by UID", %{"test_data" => test_data} do
    test_data_rpbuid_response = get_uid(test_data)
  ...
  test "Account Set Password", %{"test_data" => test_data} do
    ...
    test_data_set_password_response = get_uid(test_data)
  ...
  test "Account Update", %{"test_data" => test_data} do
    ...
    test_data_update_response = get_uid(test_data)
      |> LoginRadius.Account.update(update_data, false)

    assert_value = elem(test_data_update_response, 1)
      |> elem(1)
      |> Map.fetch!("Gender")
  ...
  test "Account Update Security Question Configuration", %{"test_data" => test_data} do
    ...
    test_data_usqc_response = get_uid(test_data)
  ...
  test "Account Invalidate Verification Email", %{"test_data" => test_data} do
    ...
    test_account_ive_response = get_uid(test_data)
  ...
  test "Account Email Delete", %{"test_data" => test_data} do
    ...
    test_data_update_response = get_uid(test_data)
      |> LoginRadius.Account.update(update_data, false)
    assert_value1 = elem(test_data_update_response, 1)
      |> elem(1)
      |> Map.fetch!("Email")
      |> List.last
      |> Map.fetch!("Value")
    ...
    test_data_delete_response = get_uid(test_data)
      |> LoginRadius.Account.email_delete(delete_data)

    assert_value2 = elem(test_data_delete_response, 1)
      |> elem(1)
      |> Map.fetch!("Email")
      |> List.last
      |> Map.fetch!("Value")
  ...
  test "Test Account Delete", %{"test_data" => _test_data} do
    IO.puts("If tests are being set up and cleaned properly, this API (Account Delete) is working properly.")
  end
end
