defmodule LoginRadius.SmartLogin do
  ...
  @default_params [{"apikey", Application.fetch_env!(:loginradius_elixir_sdk, :apikey)}]
  ...
  https://docs.loginradius.com/api/v2/user-registration/smart-login-by-email
  """
  @spec login_by_email(String.t(), String.t(), String.t(), String.t(), String.t()) :: Loginradius.response()
  ...
  https://docs.loginradius.com/api/v2/user-registration/smart-login-by-username
  """
  @spec login_by_username(String.t(), String.t(), String.t(), String.t(), String.t()) :: Loginradius.response()
  ...
  https://docs.loginradius.com/api/v2/user-registration/smart-login-ping
  """
  @spec ping(String.t()) :: LoginRadius.response()
  ...
  https://docs.loginradius.com/api/v2/user-registration/smart-login-verify-token
  """
  @spec verify_token(String.t(), String.t()) :: LoginRadius.response()
